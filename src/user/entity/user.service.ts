...
export class UserService {
  ...
  Here's how switchMap works:
    * When a new value is emitted by the source observable, switchMap cancels the
   previous inner observable (if it exists) and starts a new inner observable based on 
   the emitted value.
